...
public class SimpleRoutingAlgorithm extends AbstractRoutingAlgorithm {
    ...
    public SimpleRoutingAlgorithm(int lookahead) {
        this(lookahead, lookahead);
    }

    public SimpleRoutingAlgorithm(int lookahead, int recomp) {
        this.lookahead = lookahead;
